...
<t/><b>python testOne.py</b><br/>
<t/>Please enter the name of the file you want to use to train: <b>train.txt</b> <br/>
<t/>Please enter a word: <b>th</b> <br/>
<t/>Here are some suggestions <br/>
<t/>thing (2), that (2), think (1), third (1), this (1), thoroughly. (1), the (1)
